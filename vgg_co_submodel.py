...
def main():
    ...
    vgg_co_submodel = VGG_co_submodel()
    vgg_co_submodel = vgg_co_submodel.to(device)
    if os.path.isfile('./checkpoint/vgg_co_submodel.pth'):
        vgg_co_submodel.load_state_dict(
            torch.load('./checkpoint/vgg_co_submodel.pth'))
    ...
    vgg_co_submodel_optimizer = optim.SGD(vgg_co_submodel.parameters(),
                                          lr=cfg['lr'],
    ...
    def train(current, iterations, accs):
        ...
        for batch_idx, (x, label) in enumerate(trainloader):
            ...
            vgg_co_submodel_optimizer.zero_grad()
            ...
            vgg_co_submodel_optimizer.step()
    ...
    torch.save(vgg_co_submodel.state_dict(),
               './checkpoint/vgg_co_submodel.pth')
