...
def main(local_rank, node_rank, local_size, world_size):
    ...
    dc_ccl_high_level_encoder_cloud = VGG_co_high_level_encoder()
    dc_ccl_clasifier_cloud = VGG_co_classifier()
    dc_ccl_cloud_trainer = Trainer(
        cfg['dc_ccl_cloud'],
        shared_encoder=vgg_shared_encoder,
        high_level_encoder=dc_ccl_high_level_encoder_cloud,
        model=dc_ccl_clasifier_cloud,
